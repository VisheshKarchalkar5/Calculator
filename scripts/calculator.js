function equivalentCheck() { //This allows the last value to remain in the view until other buttons are pressed.
...
function input(x){
    ...
    if(document.getElementById('decimalVar').value == 0)
        {
            x+= y * 10; //multiply the text inout by 10 and add the value of x.
            ...
            if(decimalCount == 1){
                ...
                y += x;
                document.getElementById('result').value = y; //Return y to the text output.
        }
...
function decimalPoint() {
    ...
    if(parseInt(document.getElementById('opeartion').value)){ //This is an empty string, it will retun false. 
        document.getElementById('result').value = 0;
    }
